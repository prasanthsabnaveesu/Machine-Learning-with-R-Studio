setwd("C:/Users/Classroom 4/Desktop/Batch 34/CSE7302c/Day04")
...
library(ggbiplot)
require(ggbiplot)
g <- ggbiplot(pca.out, obs.scale = 1, var.scale = 1,groups = WineData$WineClass, ellipse = TRUE, circle = TRUE) 
